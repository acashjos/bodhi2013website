...
define('user' , 'bodhi_hunt2k1300');
define('domain' , 'localhost');
define('pass' , 'Qv.+TekwolMZ');
define('db' , 'bodhi_online2k13hunt');
...
function check($result)
     {
          if(!$result)
             {
                 print '<b><br/><br/> Sorry , We are facing some problem with the database connectivity. 
                 Please return after some time.<br/> Thank You. </b>'.mysql_error();
                 exit ;
             }
     }   
